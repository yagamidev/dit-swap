...
Setup
-----
After completing windows setup then run ditcoin-qt.
Alternatively you can run windows command line (cmd) in ditcoin program dir.
  cd daemon
  ditcoind
You would need to create a configuration file ditcoin.conf in the default
wallet directory. Grant access to ditcoind/ditcoin-qt in anti-virus and firewall
applications if necessary.

The software automatically finds other nodes to connect to.  You can
enable Universal Plug and Play (UPnP) with your router/firewall
or forward port 9884 (TCP) to your computer so you can receive
