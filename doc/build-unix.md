...
UNIX BUILD NOTES FOR DITCOIN
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/ditcoin/ditcoin
	cd ditcoin
...
This will build Ditcoin-Qt as well if the dependencies are met.
...
Note: Currently, there is no ditcoin ebuild available in overlay 
...
Notes
-----
The release is built with GCC and then "strip ditcoind" to strip the debug
